...
To print a list of code listings, the \verb|listings| package provides the \verb|\lstlistoflistings| command. This document does not make use of this. Please see \autoref{sec:listings_vs_listing} on \autopageref{sec:listings_vs_listing} for information about the method used in this document.
